            ...
            <div class="container">
                <div class="row ">
                    <div class="col-lg-9 col-md-9 head-text">
                        <h1 id="divDisp" >Vehicle services Management </h1>
                        <span >
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="div-trans text-center">
                           ...
                           <form action="" method="post">
								...
								<div class="form-group">
                                    <input type="text" class="form-control" name="state" required="required" placeholder="state">
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" name="mobile" required="required" placeholder="Mobile Number">
                                </div>
								<div class="form-group">
								  <input type="text" class="form-control" name="userid" required="required" placeholder="userid">
                                </div>
								<div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="submit" class="btn btn-success btn-block btn-lg">SUBMIT NOW</button>
                                </div>
                                </form>
                             </div>
...
$query ="INSERT INTO user_info(User_id, username, email, mobile, state, city, password, address) VALUES('$userid','$username','$email','$mobile',
'$state','$city','$password','$address')";

if(!mysqli_query($con, $query))
{
    ?>
<script>
    window.location = 'http://localhost/vehicle/admin/login.php';
</script>
<?php
}
else
